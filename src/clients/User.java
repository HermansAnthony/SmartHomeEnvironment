...
public class User extends Client {
	...
	private void openFridge(int id) throws InterruptedException, AvroRemoteException {
		...
		try {
			fridgeProxy.setFridgeUser(controllerConnection.getId());
		} catch (AvroRemoteException e){
			System.out.println("Variable fridge User is not set");
		}
	...
	// Handle the given input commands and execute the necessary steps	
	...
	// Code for the connection of the user	
	...
	@Override
	// This method will be called whenever a fridge is empty (and when user is not using the fridge)	
	...
	@Override
	// This method will be called whenever another user enters/leaves the house	
